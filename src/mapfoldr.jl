...
Multi-threaded version of [mapfoldr(f, op, itr; init)](https://docs.julialang.org/en/stable/stdlib/collections/#Base.mapfoldr). Only the **mapping** part is parallelised.
"""
