...
Multi-threaded version of [mapreduce(f, op, v0, itr)](https://docs.julialang.org/en/stable/stdlib/collections/#Base.mapreduce). Only the **reduction** part is parallelised.
"""
...
Multi-threaded version of [mapreduce(f, op, itr)](https://docs.julialang.org/en/stable/stdlib/collections/#Base.mapreduce). Only the **reduction** part is parallelised.
"""
...
Multi-threaded version of [mapreduce(f, op, v0, itr)](https://docs.julialang.org/en/stable/stdlib/collections/#Base.mapreduce). Both the **mapping** and the **reduction** part is parallelised.
"""
...
Multi-threaded version of [mapreduce(f, op, itr)](https://docs.julialang.org/en/stable/stdlib/collections/#Base.mapreduce). Both the **mapping** and the **reduction** part is parallelised.
"""
