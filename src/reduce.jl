...
Multi-threaded version of [reduce(op, itr; init)](https://docs.julialang.org/en/v1.2/base/collections/#Base.reduce-Tuple{Any,Any}). Note that function `op` must **not** change type!
"""
...
Multi-threaded version of [reduce(op, itr)](https://docs.julialang.org/en/v1.2/base/collections/#Base.reduce-Tuple{Any,Any}). Note that function `op` must **not** change type!
"""
