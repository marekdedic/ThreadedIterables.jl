...
Multi-threaded version of [mapfoldl(f, op, itr; init)](https://docs.julialang.org/en/v1.1/base/collections/#Base.mapfoldl-Tuple{Any,Any,Any}). Only the **mapping** part is parallelised.
"""
...
Multi-threaded version of [mapfoldl(f, op, itr)](https://docs.julialang.org/en/v1.1/base/collections/#Base.mapfoldl-Tuple{Any,Any,Any}). Only the **mapping** part is parallelised.
"""
