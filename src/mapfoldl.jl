...
Multi-threaded version of [mapfoldl(f, op, itr; init)](https://docs.julialang.org/en/stable/stdlib/collections/#Base.mapfoldl). Only the **mapping** part is parallelised.
"""
